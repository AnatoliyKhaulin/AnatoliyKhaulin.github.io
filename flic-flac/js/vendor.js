...
var CustomSelect = function ($) {
  ...
  function () {
    ...
    function CustomSelect(select, options) {
      ...
      this._options = _objectSpread({}, defaults, _typeof(options) === 'object' ? options : {}); // Modifiers
...
/***/ "./node_modules/jquery.nice-number/src/jquery.nice-number.js":
/*!*******************************************************************!*\
  !*** ./node_modules/jquery.nice-number/src/jquery.nice-number.js ***!
  \*******************************************************************/
/*! no static exports found */
  ...
  $.fn.niceNumber = function (options) {
    ...
    return this.each(function () {
      var currentInput = this,
          ...
          attrMax = null,
          attrMin = null; // Handle max and min values

      if (_typeof($currentInput.attr('max')) !== ( true ? "undefined" : undefined) && $currentInput.attr('max') !== false) {
        attrMax = parseFloat($currentInput.attr('max'));
      }

      if (_typeof($currentInput.attr('min')) !== ( true ? "undefined" : undefined) && $currentInput.attr('min') !== false) {
